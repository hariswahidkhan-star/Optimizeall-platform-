...
public sealed class ImpersonationCoverageTests
{
    ...
    private static readonly HashSet<string> SensitivePermissions = new(StringComparer.Ordinal)
    {
        ...
        Permissions.CodesManage, Permissions.CodesAssign, Permissions.SalesReview, Permissions.SalesReverse,
    ...
    private static readonly string[] MustDenyWrites =
    {
        ...
        "WebsiteSeoController.UpdateSettings",
        "WebsitePartnersController.Create",
        "WebsitePartnersController.Update",
        "WebsitePartnersController.Delete",
        "WebsitePartnersController.Reorder",
        "AdminJobsController.Run",
        "ReviewController.Decide",
        "ReviewController.ResolveAppeal",
        // Discount-code sales: approvals, refunds, payout rules, imports, assignment and participants' sale claims.
        "CodeSalesController.Decide",
        "CodeSalesController.BulkApprove",
        "CodeSalesController.Refund",
        "CodeProgramsController.UpdatePayout",
        "CodeProgramsController.CreateOverride",
        "CodeProgramsController.ImportCodes",
        "CodeProgramsController.ImportSales",
        "CodeProgramsController.AddSale",
        "CodeProgramsController.AutoAssign",
        "DiscountCodesController.Assign",
        "DiscountCodesController.Unassign",
        "MeCodeSalesController.Create",
        "MeCodeSalesController.Update",
        "MeCodeSalesController.Withdraw",
