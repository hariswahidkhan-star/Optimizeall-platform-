...
public sealed class DefaultDenyTests(ApiFactory api) : IClassFixture<ApiFactory>
{
    ...
    private static readonly string[] IntendedPublic =
    {
        ...
        "GET robots.txt",
        // Free public academy (Learning module): catalog, course and lesson pages, badges, certificate verification,
        // certificate PDF/SVG, the server-rendered verification page and Open Badges 2.0 hosted documents.
        ...
        "GET api/v1/public/learning/certificates/{id:guid}",
        "GET api/v1/public/learning/certificates/verify",
        "GET api/v1/public/learning/certificates/{id:guid}/page",
        "GET api/v1/public/learning/certificates/{id:guid}/certificate.pdf",
        "GET api/v1/public/learning/certificates/{id:guid}/certificate.svg",
        "GET api/v1/public/learning/openbadges/issuer",
        "GET api/v1/public/learning/openbadges/badges/{slug}",
        "GET api/v1/public/learning/openbadges/assertions/{id:guid}",
