...
public static class PagingExtensions
{
    ...
    /// <summary>Rows up to and including a 1-based page (skip + take), capped at <see cref="int.MaxValue"/> like <see cref="SkipFor"/>.</summary>
    public static int EndFor(int page, int pageSize) => (int)Math.Clamp((long)page * pageSize, 0, int.MaxValue);
