...
export const nav: PortalNavItem[] = [
  ...
  { to: 'website/partners', label: 'Partners', icon: Handshake, description: 'Partner profiles, sponsored placements and their report.', requires: requires.site },
...
export const routes: RouteObject[] = [
  ...
  page('website/partners', () => import('./pages/PartnersAdmin'), 'PartnersAdminPage', requires.site),
  page('website/partners/report', () => import('./pages/PartnersAdmin'), 'PartnerReportPage', requires.site),
