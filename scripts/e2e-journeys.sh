...
#                         handling; Baseline seed), "j-campaigns" (campaign manager + reviewer journey; Demo seed) or "j-content"
#                         (site content, SEO and landing-page builder staff journey; Demo seed)
#   E2E_SEED              comma-separated seed profiles (default: Baseline for journeys and j-participant,
#                         Baseline,Demo for agency, platform, j-delivery, j-campaigns, j-content, a11y and crawl)
...
case "$E2E_SUITE" in
  agency|platform|j-delivery|j-campaigns|j-content|a11y|crawl) E2E_SEED="${E2E_SEED:-Baseline,Demo}" ;;
