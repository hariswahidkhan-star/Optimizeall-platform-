...
#                         read-only) or "j-participant" (one participant's full lifecycle, registration to payout,
#                         referral, support and session handling; Baseline seed)
#   E2E_SEED              comma-separated seed profiles (default: Baseline for journeys and j-participant,
#                         Baseline,Demo for agency, platform, a11y and crawl)
...
case "$E2E_SUITE" in
  agency|platform|a11y|crawl) E2E_SEED="${E2E_SEED:-Baseline,Demo}" ;;
