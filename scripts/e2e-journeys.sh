...
#                         read-only) or "j-finance" (the finance money journey: payouts and the payments hub, end to
#                         end with its negative paths; Demo seed)
#   E2E_SEED              comma-separated seed profiles (default: Baseline for journeys, Baseline,Demo for agency,
#                         platform, a11y and crawl)
...
case "$E2E_SUITE" in
  agency|platform|a11y|crawl|j-finance) E2E_SEED="${E2E_SEED:-Baseline,Demo}" ;;
