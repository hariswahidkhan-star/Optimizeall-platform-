...
#                         handling; Baseline seed), "j-campaigns" (campaign manager + reviewer journey; Demo seed) or
#                         "j-social" (social media + paid ads journey; Demo seed; publishes through a local Graph API stub
#                         that the suite's global setup serves on $E2E_STUB_PORT)
...
case "$E2E_SUITE" in
  agency|platform|j-delivery|j-campaigns|j-social|a11y|crawl) E2E_SEED="${E2E_SEED:-Baseline,Demo}" ;;
