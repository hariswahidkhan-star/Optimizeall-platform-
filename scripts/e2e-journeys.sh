...
#                         Demo seed), "j-admin" (the platform-administration journey: users, roles, test accounts,
#                         "log in as", audit, settings, content, jobs, search and negatives; Demo seed), "a11y" (accessibility & responsive audit of every portal; Demo seed,
#                         read-only) or "crawl" (every role walks every page and the public website; Demo seed,
#                         read-only)
#   E2E_SEED              comma-separated seed profiles (default: Baseline for journeys, Baseline,Demo for agency,
#                         platform, j-admin, a11y and crawl)
...
case "$E2E_SUITE" in
  agency|platform|j-admin|a11y|crawl) E2E_SEED="${E2E_SEED:-Baseline,Demo}" ;;
